 ...
 * @author Sarai
 */
public class Reto_Casa_2 extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        //100 lineas aleatorias
        for (int i=0; i < 100; i++){
            int x0 = (int) (Math.random() * 400);
            int y0 = (int) (Math.random() * 400);
            int x1 = (int) (Math.random() * 400);
            int y1 = (int) (Math.random() * 400);
            CohenSutherland(g2d, x0, y0, x1, y1);
        }
